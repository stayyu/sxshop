...
import (
	...
	"strconv"
	"strings"
	"sxshop/user_web/forms"
	"sxshop/user_web/global"
	"sxshop/user_web/global/reponse"
...
func PassWordLogin(c *gin.Context) {
	...
	if !store.Verify(passwordLoginForm.CaptchaId, passwordLoginForm.Captcha, false) {
		fmt.Println(passwordLoginForm.CaptchaId, passwordLoginForm.Captcha)
		c.JSON(http.StatusBadRequest, gin.H{
			"captcha": "验证码错误",
		})
		return
...
func UpdateUser(ctx *gin.Context) {
	...
	_, err := global.UserSrvClient.UpdateUser(context.Background(), &proto.UpdateUserInfo{
		...
		ProfileImg: updateUserForm.ProfileImg,
