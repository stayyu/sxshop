...
import (
	...
	"io"
	"log"
	"sxshop/goods_srv/global"
	"sxshop/goods_srv/model"
...
func main() {
	//dsn := "root:root@tcp(192.168.1.130)/sxshop_good_srv?charset=utf8mb4&parseTime=True&loc=Local"
	//
...
func Mysql2Es() {
	dsn := "root:root@tcp(192.168.1.130:3306)/sxshop_good_srv?charset=utf8mb4&parseTime=True&loc=Local"
	...
	host := "http://192.168.1.130:9200"
	logger := log.New(os.Stdout, "sxshop", log.LstdFlags)
