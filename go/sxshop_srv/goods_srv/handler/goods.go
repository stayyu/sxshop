...
func (s *GoodsServer) UpdateGoods(ctx context.Context, req *proto.CreateGoodsInfo) (*emptypb.Empty, error) {
	...
	goods.Brands = goods.Brands
	goods.BrandsID = brand.ID
	goods.Category = category
	goods.CategoryID = category.ID
	goods.Name = goods.Name
	goods.GoodsSn = goods.GoodsSn
	goods.MarketPrice = goods.MarketPrice
	goods.ShopPrice = goods.ShopPrice
	goods.GoodsBrief = goods.GoodsBrief
	goods.ShipFree = goods.ShipFree
	goods.Images = goods.Images
	goods.DescImages = goods.DescImages
	goods.GoodsFrontImage = goods.GoodsFrontImage
