...
if (!Array) {
  ...
  (_easycom_uni_search_bar2 + _easycom_uni_icons2 + _easycom_uv_empty2 + _component_uni_load_more)();
}
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const historySearch = common_vendor.ref(common_vendor.index.getStorageSync("historySerach") || []);
    ...
    const onSearch = () => {
      ...
      common_vendor.index.navigateTo({
        url: "/pages/serach-list/serach-list"
      });
    };
    const onClear = () => {
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-12c0e4e1"]]);
